...
class DmCrmLogRepository extends EntityRepository
{
    public $table = "thirdparty_dmcrm_log";
    public $cols = ['id','company_id','api_type','worker','params','result','status','runtime','created','updated'];
    /**
     * 新增
     *
     * @param array $data
